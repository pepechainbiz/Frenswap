...
contract FrenSwapToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    constructor(address trustedForwarder) ERC20("FrenSwap Token", "FREN") ERC20Permit("FrenSwap Token") {
