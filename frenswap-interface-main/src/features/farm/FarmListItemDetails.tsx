...
import { FREN_DISTRIBUTOR_ADDRESS, MINICHEF_ADDRESS } from '../../constants/addresses'
...
const FarmListItem = ({ farm }) => {
  ...
  const [approvalState, approve] = useApproveCallback(typedDepositValue, FREN_DISTRIBUTOR_ADDRESS[chainId])
