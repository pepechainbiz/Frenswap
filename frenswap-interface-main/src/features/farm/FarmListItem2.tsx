...
import { FREN_ADDRESS } from '../../constants/tokens'
...
const FarmListItem2 = ({ farm, ...rest }) => {
  ...
  function getTvl() {
    let lpPrice = 0
    let decimals = 18
    if (farm.lpToken.toLowerCase() == FREN_ADDRESS[chainId].toLowerCase()) {
      lpPrice = frenPrice
                  ...
                  <div className="flex items-center space-x-2">
                    {farm?.rewards?.map((reward, i) => (
                      <div key={i} className="flex items-center">
                        <Image
                          src={`http://frenswap.club/images/tokens/fren.png`}
                          width="50px"
                          height="50px"
