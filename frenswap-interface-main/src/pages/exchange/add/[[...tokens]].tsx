...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Add Liquidity`)} | Frenswap</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the Frenswap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
      <FrenswapLogo />
