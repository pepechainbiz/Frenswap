...
export default function Faucet(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Faucet | Frenswap</title>
        <meta key="description" name="description" content="Pepechain Sepolia Faucet" />
      </Head>
          ...
          <div className="p-4 space-y-4 rounded bg-dark-900" style={{ zIndex: 1 }}>
            <div className="p-4 mb-3 space-y-3 text-center">
              <Typography component="h1" variant="h2">
                {i18n._(t`Pepechain Sepolia Faucet`)}
              </Typography>
              <Typography component="h1" variant="base">
                A Faucet is a tool that provides a small amount of PEPE for users that used the bridge to start using Frenswap.club without having to
                buy PEPE somewhere else.
              </Typography>
            </div>
            <div className="flex flex-1 justify-center text-center items-center mt-8 mb-12">
              <Image src="/images/faucet/pepechain_sepolia-faucet.png" alt="Frenswap" width={150} height={150} />
            </div>
            <div className="p-4 mb-3 space-y-1 text-center">
              <Typography component="h1" variant="base">
                Faucet balance:{' '}
                {formatNumberScale(tokenBalance[FAUCET_ADDRESS]?.toSignificant(4, undefined, 2) ?? 0, false, 4)} PEPE
              </Typography>
              <Typography component="h1" variant="base">
