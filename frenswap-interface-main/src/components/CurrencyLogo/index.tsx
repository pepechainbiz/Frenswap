...
export const getTokenLogoURL = (address: string, chainId: ChainId) => {
  return `https://raw.githubusercontent.com/frenswapclub/assets/master/blockchains/${BLOCKCHAIN[chainId]}/assets/${address}/logo.png`
}
...
const BLOCKCHAIN = {
  ...
  [ChainId.XDAI]: 'xdai',
  [ChainId.PEPECHAIN_SEPOLIA]: 'pepechain_sepolia',
  // [ChainId.OKEX]: 'okex',
}
...
function getCurrencyLogoUrls(currency) {
  ...
  if (currency.chainId in BLOCKCHAIN) {
    urls.push(
      `https://raw.githubusercontent.com/frenswapclub/assets/master/blockchains/${BLOCKCHAIN[currency.chainId]}/assets/${
        currency.address
      }/logo.png`
    )
  }
...
const BinanceCoinLogo =
  'https://raw.githubusercontent.com/frenswapclub/assets/master/blockchains/smartchain/info/logo.png'
const EthereumLogo = 'https://raw.githubusercontent.com/frenswapclub/assets/master/blockchains/ethereum/info/logo.png'
...
const Pepechain_SepoliaLogo = 'https://frenswap.club/images/tokens/pepe.png'
...
const logo: { readonly [chainId in ChainId]?: string } = {
  ...
  [ChainId.PEPECHAIN_SEPOLIA]: Pepechain_SepoliaLogo,
}
...
const fren = 'https://frenswap.club/icon.png'
