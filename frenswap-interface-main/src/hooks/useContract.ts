...
import FREN_DISTRIBUTOR_ABI from '../constants/abis/fren-distributor.json'
import FREN_VAULT_ABI from '../constants/abis/fren-vault.json'
import FREN_LOCKER_ABI from '../constants/abis/fren-locker.json'
...
export function useWETH9Contract(withSignerIfPossible?: boolean): Contract | null {
  ...
  return useContract(chainId ? WNATIVE[chainId] : undefined, WETH9_ABI, withSignerIfPossible)
}
...
export function useFrenDistributorContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && FREN_DISTRIBUTOR_ADDRESS[chainId], FREN_DISTRIBUTOR_ABI, withSignerIfPossible)
}

export function useFrenVaultContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && FREN_VAULT_ADDRESS[chainId], FREN_VAULT_ABI, withSignerIfPossible)
}

export function useLockerContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && LOCKER_ADDRESS[chainId], FREN_LOCKER_ABI, withSignerIfPossible)
}

export function useFrenPepeContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && FREN_PEPE_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function usePepeUsdcContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && PEPE_USDC_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useRibPepeContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && RIB_PEPE_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useBNBPairContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && BNB_USD_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}

export function useFrenContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && FREN_ADDRESS[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
...
export function useLimitOrderContract(withSignerIfPossibe?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(getVerifyingContract(0), LIMIT_ORDER_ABI, withSignerIfPossibe)
}
